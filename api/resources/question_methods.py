...
def create_question_logic(teacher, request):
    try:
        ...
        return create_question_failure_json_model(
            'failed to create the question, sorry. This is probably a db error.')
...
def update_question_logic(teacher, request):
    try:
        ...
        return update_question_failure_json_model(
            'failed to update the question, sorry. This is probably a db error.')
...
def delete_question_logic(teacher, request):
    try:
        ...
        return delete_question_failure_json_model(
            'failed to delete the question, sorry. This is probably a db error.')
...
def get_question_logic(teacher, request):
    try:
        ...
        return get_question_failure_json_model(
            'failed to get the question, sorry. This is probably a db error.')
